...
\begin{document}
  ...
  \begin{solucion}
      ...
      realizando una combinación lineal sobre los valores de luminosidad de la imagen. \\

      La diferencia entre ambas operaciones es que en la correlación (formalmente
      es correlación cruzada) primero refleja la imagen sobre ambos ejes antes de

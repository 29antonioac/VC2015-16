...
\begin{document}
  ...
  \begin{solucion}
    La visión por computador busca extraer información acerca de una imagen.
    Esta información puede ser identificar objetos en la imagen, contornos,
    colores, o incluso mensajes (esteganografía).
  \end{solucion}
  ...
  \begin{solucion}
      ...
      buscar siempre máscaras separables.
      Sí, ya que podríamos aplicar una máscara a cada canal de color, modificando
      cada uno de una manera distinta. Aunque separando los canales conseguiríamos
      el mismo efecto.
  \end{solucion}
  ...
  \begin{solucion}
      Los filtros de convolución podemos verlos como el producto escalar entre
  ...
  \begin{solucion}
      ...
      No tendría sentido tomar píxeles de una esquina de la imagen para alisar otra,
      ya que esos píxeles no tienen por qué tener luminosidad siquiera parecida.
  \end{solucion}
...
\texttt{\color{outcolor}Out[{\color{outcolor}5}]:}
       ...
       Los papeles de ambas en la convolución son (insertar)
  \end{solucion}
  ...
  \begin{solucion}
     	Lo clásico para reducir imágenes es lo que en programas de edición fotográfica
      se conoce como \textit{Reducir colores}. Esta operación cambia el tipo de almacenamiento
      de la imagen, pasando por ejemplo de CV\_32FC3 a CV\_8UC3, reduciendo así el
      tamaño de cada píxel. Esto puede desembocar en una pérdida de gama de colores.

      La opción general es la compresión de imágenes. Existen técnicas de compresión
      con pérdida y sin pérdida. Entre las opciones de compresión sin pérdida
      se encuentran \textit{RLE} y \textit{Deflación}, mientras que en las opciones con pérdida
      se encuentran lo arriba comentado como \textit{reducción de colores}, \textit{codificación
      por transformación} o \textit{compresión fractal}
  \end{solucion}
  \begin{cuestion}

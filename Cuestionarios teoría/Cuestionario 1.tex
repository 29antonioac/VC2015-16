...
\texttt{\color{outcolor}Out[{\color{outcolor}5}]:}
  ...
  \begin{solucion}
      ...
      Es importante primero alisar y luego submuestrear ya que si no la imagen
      se verá pixelada al conservar frecuencias muy altas de la imagen original.
  \end{solucion}
  \begin{cuestion}
  ...
  \begin{solucion}
      ...
      y submuestreo la imagen se va haciendo cada vez más uniforme.
  \end{solucion}
  \begin{cuestion}
